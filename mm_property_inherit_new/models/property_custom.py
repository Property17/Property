...
class AccountPaymentInhNew(models.Model):
    ...
    def _get_deposit_insurance_account(self, tenancy=None):
        """Insurance account from the tenant record, then the partner."""
        self.ensure_one()
        tenancy = tenancy or self.tenancy_id
        return (
            tenancy.tenant_id.tenancy_insurance_id
            or self.partner_id.tenancy_insurance_id
        )
    ...
    def _prepare_move_line_default_vals(self, write_off_line_vals=None, force_balance=None):
        ...
        # Determine tenancy for this payment:
        # - Prefer explicit tenancy_id (manual wizard)
        # - Fallback to tenancy on linked invoices (online payments / providers such as MyFatoorah)
        ...
        for move_line in move_line_vals:
            ...
            is_counterpart = (
                ...
                or (self.payment_type == 'inbound' and amount_currency < 0)
            )
